...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{|c|l|X|}
		...
		\cline{2-3}
		& 5 & Zużycie pamięci RAM przez aplikację nie powinno przekroczyć 500 megabajtów. \\
		\cline{2-3}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|l|}
	...
	Wybranie zakładki \textbf{Agencies} na bocznym pasku aplikacji, wyszukanie istniejącego przewoźnika i wciśnięcie przyciskutextbfph{Delete Selected} po wybraniu jednego z listy. &
	Dane wybranego przewoźnika zostaną usunięte. &
	Pozytywny \\
	\hline
	Pracownik &
	Dodanie nowej linii połączeń &
	Wybranie zakładki \textbf{Routes} w bocznym pasku aplikacji, przejście do widoku dodania połączenia po wciśnięciu przyciskutextbfph{Add New} oraz zapisanie zmian przyciskiem \textbf{Save}. &
	...
	Wybranie zakładki \textbf{Routes} na bocznym pasku aplikacji, wyszukanie istniejącego połączenia i wciśnięcie przyciskutextbfph{Delete Selected} po wybraniu jednego z listy. &
